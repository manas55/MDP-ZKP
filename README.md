...
The following figures are generated by the code:

Figure 4: ZKP verification success rate (run_mdp_zkp_full.py)

Figure 5: Model accuracy across nodes (run_rl_agent.py)

Figure 7: Aggregation time comparison (run_mdp_zkp_full.py)

Figure 8: Privacy violations (run_mdp_zkp_full.py)

Figure 9: ZKP overhead (run_mdp_zkp_full.py)

Figures 10-11: Pareto front & aggregation (plot_generation.ipynb)
